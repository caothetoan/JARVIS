// recognition voice control v1.0
// on Chrome browser
...
function switchButtonState() {
    if (isListening) {
        document.getElementById("btn").innerHTML = isListening ? 'Listen' : 'Stop';
        document.getElementById("btn").classList.add('bg-red')

        document.getElementById("btnListen").classList.add('bg-red')
    } else {
        document.getElementById("btn").innerHTML = isListening ? 'Listen' : 'Stop';
        document.getElementById("btn").classList.remove('bg-red');
        document.getElementById("btnListen").classList.remove('bg-red');
    }
